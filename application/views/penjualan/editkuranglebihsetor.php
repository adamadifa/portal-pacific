<form autocomplete="off" class="formValidate" name="autoSumForm" id="formValidate" method="POST" action="<?php echo base_url(); ?>penjualan/editkuranglebihsetor">
  ...
  <div class="row mb-3">
    <div class="col-md-12">
      ...
      <div class="input-icon">
        <input type="text" value="<?php echo $kl['tgl_kl'] ?>" id="tglbayarkl" name="tglbayarkl" class="form-control" placeholder="Tanggal Pembayaran" data-error=".errorTxt11">
  ...
  <?php if ($sess_cab == 'pusat') { ?>
    <div class="form-group mb-3">
      <select disabled class="form-select" id="cabangkb" name="cabangkb" data-error=".errorTxt1">
        <option value="">-- Pilih Cabang --</option>
        <?php foreach ($cabang as $c) { ?>
          <option <?php if ($kl['kode_cabang'] == $c->kode_cabang) {
                    echo "selected";
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="input-icon">
          <input type="text" value="<?php echo number_format($kl['uang_kertas'], '0', '', '.'); ?>" onkeyup="calc()" style="text-align:right; font-weight:bold; color:#dc3545" id="uangkertas" name="uangkertas" class="form-control" placeholder="Uang Kertas" />
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="input-icon">
          <input type="text" value="<?php echo number_format($kl['uang_logam'], '0', '', '.'); ?>" onkeyup="calc()" style="text-align:right; font-weight:bold; color:#dc3545" id="uanglogam" name="uanglogam" class="form-control" placeholder="Uang Logam" />
          <span class="input-icon-addon">
            <i class="fa fa-money"></i>
          </span>
        </div>
  ...
  <div class="form-group">
    <select class="form-select" id="pembayaran" name="pembayaran" data-error=".errorTxt1">
      ...
      <option value="1" <?php if ($kl['pembayaran'] == "1") {
                          echo "selected";
                        } ?>>Kurang Setor</option>
      <option value="2" <?php if ($kl['pembayaran'] == "2") {
                          echo "selected";
                        } ?>>Lebih Setor</option>
    </select>
  </div>
