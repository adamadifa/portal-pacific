		        	...
		        	<div class="body">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                      <input style="text-align:right; font-weight: bold" readonly type="text" id="stokdus" name="stokdus" class="form-control" placeholder="Stok Dus" />
                        ...
                        <div class="col-md-2" id="pack">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                      <input style="text-align:right; font-weight: bold" readonly type="text" id="stokpack" name="stokpack" class="form-control"  placeholder="Stok pack" />
                        ...
                        <div class="col-md-2" >
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                      <input style="text-align:right; font-weight: bold" readonly type="text" id="stokpcs" name="stokpcs" class="form-control"  placeholder="Stok Pcs" />
		        ...
		        <div class="row">
		        	...
		        	<div class="col-md-6">
	                        ...
	                        <div class="form-group">
	                        	...
	                        	<div class="col-md-8">
		                            <div class="form-line">
		                                <input type="text" value="0"  style="text-align:right" id="potongan" name="potongan" class="form-control money" placeholder="Potongan" onFocus="startCalc();" >
		                            </div>
...
<script type="text/javascript">
	...
	function terbilang(){
	    var bilangan=document.autoSumForm.totalbayar.value;
	    var kalimat="";
	    ...
	    document.getElementById("terbilangtotalbayar").innerHTML=kalimat;
	}
