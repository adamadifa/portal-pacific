          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header bg-dark text-white">
                <h4 class="card-title">Laporan Penjualan Berdasarkan Pelanggan</h4>
              </div>
              <div class="card-body">
                <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporanpenjualan/cetak_rekappelanggan" target="_blank">
                  <?php if ($cb == 'pusat') { ?>
                    <div class="mb-3">
