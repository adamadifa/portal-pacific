          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header bg-dark text-white">
                <h4 class="card-title">Rekap Penjualan ( LPC )</h4>
              </div>
              <div class="card-body">
                <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporanpenjualan/cetak_rekappenjualan" target="_blank">
                  ...
                  <div class="mb-3 form-group">
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-3" id="bagiansampai">
                        <div class="input-icon">
