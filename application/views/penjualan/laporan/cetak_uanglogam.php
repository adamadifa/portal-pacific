  ...
  <tbody>
    ...
    ?>
      <tr>
        ...
        <td align="right" style="font-weight:bold; color:green"><?php if (!empty($lhp)) {
                                                                  echo uang($lhp);
                                                                } ?></td>
        <td align="right" style="font-weight:bold; color:red"><?php if (!empty($setoranpusat)) {
                                                                echo uang($setoranpusat);
                                                              } ?></td>
        <td align="right" style="font-weight:bold;"><?php if (!empty($saldo)) {
                                                      echo uang($saldo);
                                                    } ?></td>
      </tr>
    <?php
