        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporanpenjualan/cetak_rekapkendaraan" target="_blank">
                  <?php if ($cb == 'pusat') { ?>
                    <div class="mb-3">
    ...
    function loadKendaraan() {
      ...
      $.ajax({
        ...
        success: function(respond) {
          $('#kendaraan').selectize()[0].selectize.destroy();
          $("#kendaraan").html(respond);
          $('#kendaraan').selectize({});
