...
<table class="datatable3" style="width:150% !important">
	...
	<tbody>
		...
		<tr bgcolor="#024a75" style="color:white; font-size:12;">
			...
			<td style="text-align: right"><a href="<?php echo base_url(); ?>laporanpenjualan/cetak_detailaup/<?php echo $cbg . "/" . $sales . "/" . $plg . "/" . $tanggal . "/duaminggu/" . $filter; ?>" target="_blank"><?php echo number_format($totalallduaminggu, '0', '', '.');  ?></a></td>
			<td style="text-align: right"><a href="<?php echo base_url(); ?>laporanpenjualan/cetak_detailaup/<?php echo $cbg . "/" . $sales . "/" . $plg . "/" . $tanggal . "/satubulan/" . $filter; ?>" target="_blank"><?php echo number_format($totalallsatubulan, '0', '', '.');  ?></a></td>

			<td style="text-align: right"><a href="<?php echo base_url(); ?>laporanpenjualan/cetak_detailaup/<?php echo $cbg . "/" . $sales . "/" . $plg . "/" . $tanggal . "/satubulan15/" . $filter; ?>" target="_blank"><?php echo number_format($totalallsatubulan15, '0', '', '.');  ?></a></td>
			<td style="text-align: right"><a href="<?php echo base_url(); ?>laporanpenjualan/cetak_detailaup/<?php echo $cbg . "/" . $sales . "/" . $plg . "/" . $tanggal . "/duabulan/" . $filter; ?>" target="_blank"><?php echo number_format($totalallduabulan, '0', '', '.');  ?></a></td>
			<td style="text-align: right"><a href="<?php echo base_url(); ?>laporanpenjualan/cetak_detailaup/<?php echo $cbg . "/" . $sales . "/" . $plg . "/" . $tanggal . "/tigabulan/" . $filter; ?>" target="_blank"><?php echo number_format($totalalllebih3bulan, '0', '', '.');  ?></a></td>
			<td style="text-align: right"><a href="<?php echo base_url(); ?>laporanpenjualan/cetak_detailaup/<?php echo $cbg . "/" . $sales . "/" . $plg . "/" . $tanggal . "/enambulan/" . $filter; ?>" target="_blank"><?php echo number_format($totalallenambulan, '0', '', '.');  ?></a></td>
			<td style="text-align: right"><a href="<?php echo base_url(); ?>laporanpenjualan/cetak_detailaup/<?php echo $cbg . "/" . $sales . "/" . $plg . "/" . $tanggal . "/duabelasbulan/" . $filter; ?>" target="_blank"><?php echo number_format($totalallduabelasbulan, '0', '', '.');  ?></a></td>
			<td style="text-align: right"><a href="<?php echo base_url(); ?>laporanpenjualan/cetak_detailaup/<?php echo $cbg . "/" . $sales . "/" . $plg . "/" . $tanggal . "/duatahun/" . $filter; ?>" target="_blank"><?php echo number_format($totalallduatahun, '0', '', '.');  ?></a></td>
			<td style="text-align: right"><a href="<?php echo base_url(); ?>laporanpenjualan/cetak_detailaup/<?php echo $cbg . "/" . $sales . "/" . $plg . "/" . $tanggal . "/lebihduatahun/" . $filter; ?>" target="_blank"><?php echo number_format($totalalllebihduatahun, '0', '', '.');  ?></a></td>
			<td style="text-align: right"><a href="<?php echo base_url(); ?>laporanpenjualan/cetak_detailaup/<?php echo $cbg . "/" . $sales . "/" . $plg . "/" . $tanggal . "/all/" . $filter; ?>" target="_blank"><?php echo number_format($totalall, '0', '', '.');  ?></a></td>
