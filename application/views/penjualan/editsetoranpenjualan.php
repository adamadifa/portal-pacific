<form autocomplete="off" class="formValidate" name="autoSumForm" id="formValidate" method="POST" action="<?php echo base_url(); ?>penjualan/editsetoranpenjualan">
  <input type="hidden" value="<?php echo $setoran['kode_setoran']; ?>" name="kode_setoran" class="form-control">
  <div class="row mb-3">
    <div class="col-md-12">
      <label class="form-label">Tanggal</label>
      <div class="input-icon">
        <input type="date" value="<?php echo $setoran['tgl_lhp']; ?>" disabled id="tgllhpkb" name="tgllhpkb" class="form-control" placeholder="Tanggal LHP" />
  ...
  <div class="row mb-3">
    ...
    <div class="form-group">
      <select name="cabangkb" disabled id="cabangkb" class="form-select">
        <option value="">-- Pilih Cabang --</option>
        <?php foreach ($cabang as $c) { ?>
          <option <?php if ($setoran['kode_cabang'] == $c->kode_cabang) {
                    echo "selected";
  ...
  <div class="row mb-3">
    <div class="col-md-12">
      ...
      <div class="form-group">
        <select disabled id="salesmankb" name="salesmankb" class="form-select">
          <option selected value="<?php echo $setoran['id_karyawan']; ?>"><?php echo $setoran['nama_karyawan']; ?></option>
        </select>
      </div>
    </div>
  </div>
  ...
  <table class="table">
    <tr>
      ...
      <td>
        <input type="hidden" value="<?php echo $setoran['lhp_tunai'] ?>" readonly style="text-align:right; font-weight:bold" id="tunai" name="tunai" class="form-control" placeholder="Tunai">
        <div id="terbilang" style="float:right; font-weight:bold; color:#1ab394"><?php echo number_format($setoran['lhp_tunai'], '0', '', '.'); ?></div>
      </td>
    </tr>
    <tr>
      <td style="font-weight: bold;">Tagihan</td>
      <td>
        <input type="hidden" value="<?php echo $setoran['lhp_tagihan'] ?>" readonly style="text-align:right; font-weight:bold" id="tagihan" name="tagihan" class="form-control" placeholder="Tagihan">
        <div id="terbilangtagihan" style="float:right; font-weight:bold; color:#1ab394"><?php echo number_format($setoran['lhp_tagihan'], '0', '', '.'); ?></div>
      </td>
    </tr>
    <tr>
      <td style="font-weight: bold;">Total</td>
      <td>
        <input type="hidden" value="<?php echo $setoran['lhp_tunai'] + $setoran['lhp_tagihan']; ?>" readonly style="text-align:right; font-weight:bold" id="totallhp" name="totallhp" class="form-control" placeholder="Total LHP">
        <a id="detaillhp" href="#" target="_blank">
          <div id="terbilangtotallhp" style="float:right; font-weight:bold; color:#1ab394"><?php echo number_format($setoran['lhp_tunai'] + $setoran['lhp_tagihan'], '0', '', '.'); ?></div>
        </a>
      </td>
    </tr>
  </table>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="input-icon">
          <input type="text" value="<?php echo number_format($setoran['setoran_kertas'], '0', '', '.'); ?>" onkeyup="calc()" style="text-align:right; font-weight:bold; color:#dc3545" id="uangkertas" name="uangkertas" class="form-control" placeholder="Uang Kertas" />
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="input-icon">
          <input type="text" value="<?php echo number_format($setoran['setoran_logam'], '0', '', '.'); ?>" onkeyup="calc()" style="text-align:right; font-weight:bold; color:#dc3545" id="uanglogam" name="uanglogam" class="form-control" placeholder="Uang Logam" />
          <span class="input-icon-addon">
            <i class="fa fa-money"></i>
          </span>
        </div>
  ...
  <table class="table mt-3">
    <tr>
      ...
      <td>
        <input type="hidden" value="<?php echo $setoran['setoran_bg']; ?>" onkeyup="calc()" style="text-align:right; color:#dc3545" id="bgcek" name="bgcek" class="form-control" placeholder="BG / CEK">
        <div id="terbilangbg" style="float:right; font-weight:bold; color:#dc3545"><?php echo number_format($setoran['setoran_bg'], '0', '', '.'); ?></div>
      </td>
    </tr>
    <tr>
      <td style="font-weight: bold;">Transfer</td>
      <td>
        <input type="hidden" <?php echo $setoran['setoran_transfer']; ?> onkeyup="calc()" style="text-align:right; color:#dc3545" id="transfer" name="transfer" class="form-control" placeholder="TRANSFER">
        <div id="terbilangtrf" style="float:right; font-weight:bold; color:#dc3545"><?php echo number_format($setoran['setoran_transfer'], '0', '', '.'); ?></div>
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <div id="terbilangtotalsetoran" style="float:right; font-weight:bold; color:#dc3545"><?php echo number_format(($setoran['setoran_kertas'] + $setoran['setoran_logam'] + $setoran['setoran_bg'] + $setoran['setoran_transfer']), '0', '', '.'); ?></div>
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <div id="terbilangselisih" style="float:right; font-weight:bold; color:#dc3545"><?php echo number_format(($setoran['setoran_kertas'] + $setoran['setoran_logam'] + $setoran['setoran_bg'] + $setoran['setoran_transfer']) - ($setoran['lhp_tunai'] + $setoran['lhp_tagihan']), '0', '', '.'); ?></div>
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        <div id="terbilanggirotocash" style="float:right; color:#f8ac59"><?php echo number_format($setoran['girotocash'], '0', '', '.'); ?></div>
      </td>
    </tr>
  </table>
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="input-icon">
          <input type="text" value="<?php echo $setoran['keterangan']; ?>" id="keterangan" name="keterangan" class="form-control" placeholder="Keterangan" />
          <span class="input-icon-addon">
