...
<form name="autoSumForm" autocomplete="off" class="formValidate form-horizontal" id="formValidate"  method="POST" action="<?php echo base_url(); ?>penjualan/retur_penjualan">
        ...
        <div class="modal-content">
            <div class="card">
			    <div class="header bg-cyan">
			     ...
			     <div class="body">
			        <div class="row clearfix">
			            <div class="col-sm-12" id="loadDetailRetur">
			            </div>
			        </div>
			    </div>
			</div>
