  ...
  <div class="row">
    <div class="col-md-10 col-xs-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>produksi/opname" autocomplete="off">
            <div class="mb-3">
              <input type="text" value="<?php echo $kode_opname; ?>" id="kode_opname" name="kode_opname" class="form-control" placeholder="Kode Opname" data-error=".errorTxt19" />
            </div>
            <div class="mb-3">
              <div class="row">
                <div class="col-md-12">
          ...
          <a href="<?php echo base_url(); ?>produksi/inputopname" class="btn btn-danger mb-3">Tambah Data</a>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td width="10px">
                      <a href="#" data-kode_opname="<?php echo $d['kode_opname']; ?>" class="btn btn-sm btn-primary detail">Detail</a>
                      <a href="#" data-href="<?php echo base_url(); ?>produksi/hapusopname/<?php echo $kode_opname; ?>" class="btn btn-sm btn-danger hapus">Hapus</a>
                    </td>
                  </tr>
                <?php
                  $no++;
