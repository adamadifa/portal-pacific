  ...
  <div class="row">
    <div class="col-md-10 col-xs-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>produksi/pemasukan" autocomplete="off">
            <div class="mb-3">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="input-icon">
                    <input id="tgl_pemasukan" type="date" value="<?php echo $tgl_pemasukan; ?>" placeholder="Tanggal" class="form-control" name="tgl_pemasukan" />
          ...
          <a href="<?php echo base_url(); ?>produksi/input_pemasukan" class="btn btn-danger mb-3">Tambah Data</a>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="#" data-href="<?php echo base_url(); ?>produksi/hapuspemasukan/<?php echo $nobukti; ?>" class="btn btn-sm btn-danger hapus">Hapus</a>
                      <a href="<?php echo base_url(); ?>produksi/edit_pemasukan/<?php echo $nobukti; ?>" class="btn btn-sm btn-warning">Edit</a>
                    </td>
                  </tr>
                <?php
                  $no++;
