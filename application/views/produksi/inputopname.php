<form autocomplete="off" class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>produksi/input_opname">
            ...
            <div class="col-md-5 col-xs-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Input Opname</h4>
                </div>
                <div class="card-body">
                  ...
                  <div class="form-group mb-3" align="right">
                    <div class="input-icon">
                      ...
                      <a href="#" id="getopname" class="btn btn-xm bg-green  waves-effect">GET OPNAME</a>
                    </div>
                  </div>
                </div>
              </div>
