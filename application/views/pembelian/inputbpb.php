  ...
  <div class="col-md-10">
    <div class="card">
      <div class="header bg-cyan">
        <h2>
           INPUT BUKTI PERMINTAAN BARANG (BPB)
      ...
      <div class="body">
        <div class="row">
          <div class="col-md-12">
            <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>pembelian/insert_bpb">
              <input type="hidden" id="cekdatabpb" name="cekdata" value="">
              <div class="row">
                <div class="body">
                  <div class="col-md-12">
                    <div class="input-group demo-masked-input"  >
                      ...
                      <div class="form-line">
                        <input type="text" value="" id="nobpb" name="nobpb" class="form-control" placeholder="No BPB" data-error=".errorTxt19" />
                      </div>
                    </div>
                    <div class="input-group demo-masked-input"  >
                      <span class="input-group-addon">
                      ...
                      <div class="form-line">
                        <input type="text" value="" id="tgl_permintaan" name="tgl_permintaan" class="form-control date datepicker" placeholder="Tanggal Permintaan" data-error=".errorTxt19" />
                      </div>
                    </div>
                    <div class="input-group demo-masked-input"  >
                      <span class="input-group-addon">
                      ...
                      <div class="form-line">
                        <input type="text" value="" id="yangmengajukan" name="yangmengajukan" class="form-control" placeholder="Yang Mengajukan" data-error=".errorTxt19" />
                      </div>
                    </div>
                ...
                <div class="body">
                  ...
                  <div class="col-md-2">
                    <div class="input-group demo-masked-input"  >
                      ...
                      <div class="form-line">
                        <input type="text" style="text-align:right" value="" readonly id="satuan" name="satuan" class="form-control" placeholder="Satuan" data-error=".errorTxt19" />
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
  ...
  $(function(){
    ...
    $(".formValidate").submit(function(){
      ...
      if(nobpb == "")
      {
        ...
        return false;
      }else if(cekdatabpb=="" || cekdatabpb==0){
        swal("Oops!", "List Barang Harus Diisi !", "warning");
        return false;
      }else{
        return true;
      }
    ...
    {
      var departemen = $("#departemen").val();
      $("#tabelbarang").load("<?php echo base_url(); ?>pembelian/tabelbarang/"+departemen);
    }
    ...
    $("#tambahbarang").click(function(e){
      ...
      if(barang ==""){
        ...
        $.ajax({
          type      : 'POST',
          url       : '<?php echo base_url(); ?>pembelian/insertdetailbpb_temp',
          data      : {kodebarang:kodebarang,barang:barang,jumlah:jumlah,keterangan:keterangan},
          cache     : false,
          success   : function(respond){
            if(respond == 1){
    ...
    function loadNoBPB()
    {
      ...
      $.ajax({
        type     : 'POST',
        url      : '<?php echo base_url(); ?>pembelian/getNoBPB',
        data     : {kodedept:kodedept,tgl_permintaan:tgl_permintaan},
        cache    : false,
        success  : function(respond){
          $("#nobpb").val(respond);
        }
