...
foreach($detail->result() as $d){  
  ...
  <tr>
    ...
    <td>
      <a href="#"  data-kodebarang="<?php echo $d->kode_barang; ?>" data-nama="<?php echo $d->nama_barang; ?>" data-jenis="<?php echo $d->jenis_barang; ?>"  data-qty="<?php echo $d->qty_berat; ?>" class="btn btn-warning btn-sm edit">Edit</a>
    </td>
  </tr>
  <?php $no++; 
}  ?>
