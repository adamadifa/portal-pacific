<form autocomplete="off" class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>gudangbahan/input_saldoawal">
                ...
                <div class="card-body">
                  <div class="form-group mb-3">
                    <div class="input-icon">
                      ...
                      <input type="hidden" name="jumlahproduk" id="jumlahproduk"></div>
                  </div>
                  <div class="form-group mb-3">
                    <div class="input-icon">
                      <span class="input-icon-addon">
