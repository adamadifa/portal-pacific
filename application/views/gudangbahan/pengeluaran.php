  ...
  <div class="row">
    <div class="col-md-10 col-xs-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>gudangbahan/pengeluaran" autocomplete="off">
            <div class="mb-3">
          ...
          <a href="<?php echo base_url(); ?>gudangbahan/input_pengeluaran" class="btn btn-danger mb-3">Tambah Data</a>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $d['kode_dept']; ?> <?php if ($d['kode_dept'] == 'Produksi'){ echo "Unit ".$d['unit']; }else if($d['kode_dept'] == 'Cabang'){ echo $d['unit'];} ?></td>
                    <td>
                      <a href="#" data-nobukti="<?php echo $d['nobukti_pengeluaran']; ?>" class="btn btn-sm btn-primary detail">Detail</a>
                      <a href="#" data-href="<?php echo base_url(); ?>gudangbahan/hapuspengeluaran/<?php echo $nobukti; ?>" class="btn btn-sm btn-danger hapus">Hapus</a>
                      <a href="<?php echo base_url(); ?>gudangbahan/edit_pengeluaran/<?php echo $nobukti; ?>" class="btn btn-sm btn-warning">Edit</a>
                    </td>
                  </tr>
                <?php
                  $no++;
