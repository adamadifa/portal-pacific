...
if(!empty($cek)){
  foreach ($detail as $b) {
    ...
    $qty_berat     = $b->qtyberatsa + $b->qtypemb2 + $b->qtylainnya2 - $b->qtyprod4 -$b->qtyseas4 - $b->qtypdqc4 - $b->qtylain4 - $b->qtysus4-$b->qtycabang4;
    $qty_unit      = $b->qtyunitsa + $b->qtypemb1 + $b->qtylainnya1 - $b->qtyprod3 -$b->qtyseas3 - $b->qtypdqc3 - $b->qtylain3 - $b->qtysus3-$b->qtycabang3;
