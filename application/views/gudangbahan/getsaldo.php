    ...
    <tr>
      ...
      <td style="width:100px">
        <div class="input-group demo-masked-input" style="margin-bottom:0px; !important">
          <div class="form-line">
            <input type="text" style="text-align:right" value="<?php if (!empty($qty_unit)) {
                                                                  echo $qty_unit;
                                                                } ?>" id="qty_unit" name="qty_unit<?php echo $no; ?>" class="form-control rupiah" data-error=".errorTxt19" />
          </div>
        </div>
      </td>
      <td style="width:100px">
        <div class="input-group demo-masked-input" style="margin-bottom:0px; !important">
          <div class="form-line">
            <input type="text" style="text-align:right" value="<?php if (!empty($qty_berat)) {
                                                                  echo $qty_berat;
                                                                } ?>" id="qty_berat" name="qty_berat<?php echo $no; ?>" class="form-control rupiah" data-error=".errorTxt19" />
          </div>
        </div>
      </td>
    </tr>
