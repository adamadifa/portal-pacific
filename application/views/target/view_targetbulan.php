    ...
    <div class="col-md-8">
        <div class="card">
            <div class="header bg-cyan">
                <h2>
                   Data Target Penjualan Produk Per Bulan
                    <small> Data Target Penjualan Produk Per Bulan</small>
                </h2>
            ...
            <div class="body">
                <div class="row clearfix">
                    <div class="col-md-12">
						<form autocomplete="off" class="formValidate" id="formValidate"  method="POST" action="<?php echo base_url(); ?>target/insert_targetbulan">
...
<script type="text/javascript">
    $(function(){
		...
		function loadtargetbulan(){
		  ...
		  var  tahun  = $("#tahun").val();
		  var  bulan  = $("#bulan").val();
          $("#loadtargetbulan").load("<?php echo base_url();?>target/view_targetbulantemp/"+cabang+"/"+bulan+"/"+tahun);
        }
		...
		function cek_targetbulantemp(){
			...
			$.ajax({
				...
				type    : 'POST',
				url     : '<?php echo base_url(); ?>target/cek_targetbulantemp',
		...
		$("#tambahbarang").click(function(e){
			...
			if(tahun==""){
                ...
                swal("Oops!", "Jumlah Tidak Boleh 0!", "warning");
                    ...
                    $.ajax({
                        type    : 'POST',
                        url     : '<?php echo base_url();?>target/insert_targetbulantemp',
                        data    : {
		...
		$('.detail').click(function(e){
			...
			$.ajax({
				type    : 'POST',
                url     : '<?php echo base_url(); ?>target/detail_target_bulan',
