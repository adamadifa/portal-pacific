	...
	<script type="text/javascript">
		...
		$(function(){
			function loadDetail(){
	          ...
	          $("#loadDetail").load("<?php echo base_url();?>repackreject/view_detailkirimpusattemp/"+cabang);
	        }
	        ...
	        function cekdetail(){
	            ...
	            $.ajax({
	                ...
	                type    : 'POST',
	                url     : '<?php echo base_url(); ?>repackreject/cekdetailkirimpusattemp',
	                data    : {cabang:cabang},
	                cache   :false,
	                success : function(respond){
	                    console.log(cabang);
	                    $("#cekdetailkirimpusattemp").val(respond);
	                }
			...
			$(".hapus").click(function(e){
				...
				$.ajax({
					...
					type		: 'POST',
					url 		: '<?php echo base_url(); ?>repackreject/hapus_detailbrgkirimpusat',
