<div class="container-fluid">
  ...
  <div class="page-header">
    <div class="row align-items-center">
      <div class="col-auto">
        <h2 class="page-title">
          NPUT DATA PENYESUAIAN BAD STOK
        </h2>
      </div>
    </div>
  </div>
        ...
        <div class="col-md-7">
          ...
          <div class="card">
            <div class="card-header">
              <h4 class="card-title"> NPUT DATA PENYESUAIAN BAD STOK </h4>
            </div>
            <div class="card-body">
              <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>repackreject/input_penyesuaianbad">
                <div class="form-group mb-3">
                  <div class="input-icon">
                    ...
                    <input type="text" readonly value="" id="no_mutasi" name="no_mutasi" class="form-control" placeholder="No Mutasi Penyesuaian Bad Stok" data-error=".errorTxt19" />
                  </div>
                </div>
                <?php if ($cb == 'pusat') { ?>
                  <div class="form-group mb-3">
