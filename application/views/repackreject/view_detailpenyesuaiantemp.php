	...
	<script type="text/javascript">
		...
		$(function(){
			function loadDetail(){
	          ...
	          $("#loadDetail").load("<?php echo base_url();?>repackreject/view_detailpenyesuaiantemp/"+salesman);
	        }
	        ...
	        function cekdetail(){
	            ...
	            $.ajax({
	                ...
	                type    : 'POST',
	                url     : '<?php echo base_url(); ?>repackreject/cekdetailpenyesuaiantemp',
			...
			$(".hapus").click(function(e){
				...
				$.ajax({
					...
					type		: 'POST',
					url 		: '<?php echo base_url(); ?>repackreject/hapus_detailbrgpenyesuaian',
