        ...
        <div class="col-md-10">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title"> DATA PENYESUAIAN BAD STOK</h4>
            </div>
            <div class="card-body">
              <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>repackreject/penyesuaianbad" autocomplete="off">
              ...
              <hr>
              <a href="<?php echo base_url(); ?>repackreject/inputpenyesuaianbad" class="btn btn-danger mb-3">Tambah Data</a>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td><span class="badge <?php if ($d['inout_bad'] == 'IN') {
                                                  echo 'bg-green';
                                                } else {
                                                  echo 'bg-red';
                                                } ?>"><?php echo $d['inout_bad']; ?></span></td>

                        <td>
                          <a href="#" class="btn btn-sm btn-info detail" data-nomutasi="<?php echo $d['no_mutasi_gudang_cabang']; ?>">Detail</a>
                          <a href="<?php echo base_url(); ?>repackreject/updatepenyesuaianbad/<?php echo $d['no_mutasi_gudang_cabang']; ?>" class="btn btn-sm btn-blue">Update</a>
                          <a data-href="<?php echo base_url(); ?>repackreject/hapuspenyesuaianbad/<?php echo $d['no_mutasi_gudang_cabang']; ?>" class="btn btn-sm btn-danger text-white hapus">Hapus</a>
                          </>
                      </tr>
                    <?php
                      $sno++;
