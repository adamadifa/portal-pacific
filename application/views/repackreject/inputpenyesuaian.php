        ...
        <div class="col-md-7">
          ...
          <div class="card">
            <div class="card-header">
              <h4 class="card-title"> INPUT DATA PENYESUAIAN GOOD STOK </h4>
            </div>
            <div class="card-body">
              <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>repackreject/input_penyesuaian">
                <div class="form-group mb-3">
                  <div class="input-icon">
                    ...
                    <input type="text" readonly value="" id="no_mutasi" name="no_mutasi" class="form-control" placeholder="No Mutasi Penyesuaian Good Stok" data-error=".errorTxt19" />
                  </div>
                </div>
                <?php if ($cb == 'pusat') { ?>
                  <div class="form-group mb-3">
                ...
                <table class="table table-bordered table-striped">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th colspan="6" style="text-align:center">Penyesuaian Good Stok</th>
                    </tr>
                    <tr>
