      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>repackreject/repackcab" autocomplete="off">
              ...
              <hr>
              <a href="<?php echo base_url(); ?>repackreject/inputrepackcab" class="btn btn-danger mb-3">Tambah Data</a>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="<?php echo base_url(); ?>repackreject/updaterepackcab/<?php echo $d['no_mutasi_gudang_cabang']; ?>" class="btn btn-sm btn-blue">Update</a>
                          <a data-href="<?php echo base_url(); ?>repackreject/hapusrepackcab/<?php echo $d['no_mutasi_gudang_cabang']; ?>/<?php echo $d['kode_cabang']; ?>" class="btn btn-sm btn-danger text-white hapus">Hapus</a>
                        </td>
                      </tr>
                    <?php
                      $sno++;
