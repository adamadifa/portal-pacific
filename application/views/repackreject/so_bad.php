  ...
  <div class="col-md-10">
        <div class="card">
            <div class="header bg-cyan">
                <h2>
                     STOK OPNAME BAD STOK
                    <small>Stok Opname Bad Stok</small>
                </h2>
            </div>
                            ...
                            <div class="col-md-6">  
                                <div class="input-group demo-masked-input"  >
                                    ...
                                    <div class="form-line">
                                        ...
                                        <input type="hidden" name="status" value="BAD">
                                ...
                                <?php } ?>
                                    ...
                                    <div class="input-group" >
                                        ...
                                        <div class="form-line">
                                            ...
                                            <input type="hidden" id="cekdetailsobadtemp" name="cekdetailpenyesuaiantemp" class="form-control" data-error=".errorTxt1" />
...
<div class="row clearfix">
    <div class="col-md-10">
        <div class="card">
            <div class="header bg-cyan">
                <h2>
                    DATA STOK OPNAME BAD STOK
                    <small>Data Stok Opname Bad Stok</small>
                </h2>
            </div>
                                    ...
                                    ?>
                                        <tr>
                                           ...
                                           <td>
                                                ...
                                                <a href="#" data-target="#konfirmasi_hapus" data-toggle="modal" data-href="<?php echo base_url(); ?>repackreject/hapus_so/<?php echo $d['no_so']; ?>/BAD" class="btn bg-red btn-xs"><i class="material-icons">delete</i></a>
...
<script type="text/javascript">
     ...
     $(function(){
        ...
        function loadDetail(){
          ...
          $("#loadDetail").load("<?php echo base_url();?>repackreject/view_detailsobadtemp/"+cabang);
        }
        ...
        function cekdetail(){
            ...
            $.ajax({
                ...
                type    : 'POST',
                url     : '<?php echo base_url(); ?>repackreject/cekdetailsobadtemp',
                data    : {cabang:cabang},
                cache   :false,
                success : function(respond){
                    console.log(cabang);
                    $("#cekdetailsobadtemp").val(respond);
                }
            ...
            if(cabang == ""){
               ...
               $("#databarang").modal("show");
                $.ajax({
                        ...
                        type    : 'POST',
                        url     : '<?php echo base_url(); ?>barang/view_barangcab_gjbs',
            ...
            if(kode_produk ==""){
                ...
                swal("Oops!", "Stok Memiliki Selisih Silahkan Isi Keterangan ! ", "warning");
                    ...
                    $.ajax({
                        ...
                        type    : 'POST',
                        url     : '<?php echo base_url();?>repackreject/insert_detailsobadtemp',
                        data    : {
        ...
        $(".formValidate").submit(function(){
            ...
            var cabang            = $("#cabang").val();
            var cek               = $("#cekdetailsobadtemp").val();
