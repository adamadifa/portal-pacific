                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php if ($p->status == 0 or empty($p->status)) { ?>
                            <a href="<?php echo base_url(); ?>oman/approve_permintaan/<?php echo $p->no_permintaan; ?>/<?php echo $p->no_order; ?>" class="btn btn-sm btn-success">Approve</a>
                          <?php } else if ($p->status == '1') { ?>
                            <a href="<?php echo base_url(); ?>oman/cancel_permintaan/<?php echo $p->no_permintaan; ?>/<?php echo $p->no_order; ?>" class="btn btn-sm btn-danger">Batalkan</a>
                          <?php } ?>
                        </td>
                      </tr>
                  <?php
