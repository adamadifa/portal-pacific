    ...
    <div class="col-md-10 col-xs-12">
      <div class="row">
        <div class="card">
          ...
          <div class="card-body">
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>oman" autocomplete="off">
            ...
            <a href="<?php echo base_url(); ?>oman/input_oman" class="btn btn-danger mt-2" id="tambahpel"> Tambah Data </a>
            <hr>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <?php if ($o->status == '0') { ?>
                          <!-- <a href="<?php echo base_url(); ?>oman/edit_oman/<?php echo $o->no_order; ?>" class="btn btn-sm btn-primary">Edit</a> -->
                          <a href="#" class="btn btn-danger btn-sm hapus" data-href="<?php echo base_url(); ?>oman/hapus/<?php echo $o->no_order; ?>">Hapus</a>
                        <?php } else if ($o->status == '1' or $o->status == '2') { ?>
                          <a href="#" data-noorder="<?php echo $o->no_order; ?>" class="btn btn-sm btn-info detailpermintaan">Detail Permintaan</a>
                        <?php } ?>
                      </td>
                    </tr>
                  <?php $no++;
