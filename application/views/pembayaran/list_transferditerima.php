      ...
      <div class="col-sm-12">
        ...
        <div class="tab-content">
          ...
          <ul class="nav nav-tabs tab-nav-right">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>Pembayaran/listtransferditerima">TRANSFER DITERIMA</a></li>
            <li><a href="<?php echo base_url(); ?>Pembayaran/listtransferditolak">TRANSFER DITOLAK</a></li>
          </ul>
          <div class="tab-content">
            <div class="row">
              <div class="col-md-12">
