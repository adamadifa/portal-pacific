<form autocomplete="off" class="giroForm" id="formValidate" method="POST" action="<?php echo base_url(); ?>pembayaran/editgiro">
  ...
  <input type="hidden" value="<?php echo $giro['id_giro']; ?>" id="id_giro" name="id_giro">
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        <label class="form-label">Tanggal Bayar</label>
        <div class="input-icon">
          <input type="date" value="<?php echo $giro['tgl_giro']; ?>" id="tglgiro" name="tglgiro" class="form-control" placeholder="Tgl Pencatatan Giro" />
      ...
      <div class="form-group">
        <select class="form-select" name="salesman" id="salesman">
          ...
          <?php foreach ($salesman as $s) { ?>
            <option <?php if ($giro['id_karyawan'] == $s->id_karyawan) {
                      echo "Selected";
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="input-icon">
          <input type="text" value="<?php echo $giro['no_giro']; ?>" id="nogiro" name="nogiro" class="form-control" placeholder="No Giro" />
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="input-icon">
          <input type="text" value="<?php echo $giro['namabank']; ?>" id="namabank" name="namabank" class="form-control" placeholder="Nama Bank" />
          <span class="input-icon-addon">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="input-icon">
          <input type="date" value="<?php echo $giro['tglcair']; ?>" id="tglcair" name="tglcair" class="form-control" placeholder="Jatuh Tempo" />
          <span class="input-icon-addon">
  ...
  <div class="row mb-3">
    <div class="col-md-12">
      <div class="form-group">
        ...
        <div class="input-icon">
          <input type="text" value="<?php echo $giro['jumlah']; ?>" style="text-align:right" id="jmlbayar" name="jmlbayar" class="form-control" placeholder="Jumlah Bayar" />
      ...
      $.ajax({
        ...
        success: function(respond) {
          ...
          if (status != 0) {
            ...
            $("#tglgiro").attr('disabled', 'disabled');
