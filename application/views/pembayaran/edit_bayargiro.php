<form autocomplete="off" class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>pembayaran/editbayargiro">
  ...
  <div id="jumlahbayar">
    <div class="form-group mb-3">
      <div class="input-icon">
        <input readonly type="text" value="<?php echo number_format($giro['jumlah'], '0', '', '.'); ?>" style="text-align:right" id="jmlbayar2" name="jmlbayar2" class="form-control" placeholder="Jumlah Bayar" />
        <input type="hidden" value="<?php echo $giro['jumlah']; ?>" style="text-align:right" id="jmlbayar" name="jmlbayar" class="form-control" placeholder="Jumlah Bayar" />
