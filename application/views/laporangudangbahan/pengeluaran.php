            ...
            <div class="card">
              ...
              <div class="card-body">
                <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporangudangbahan/cetak_pengeluaran" target="_blank">
                  ...
                  <div class="mb-3">
                    <select class="form-control selectoption show-tick" id="kode_dept" name="kode_dept" data-error=".errorTxt1">
                  ...
                  <div class="mb-3" id="unitproduksi">
                    <select class="form-control selectoption show-tick" id="unit" name="unit" data-error=".errorTxt1">
