  ...
  <div class="row">
    <div class="col-md-10 col-xs-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>gudanglogistik/saldoawal" autocomplete="off">
            <div class="mb-3">
          ...
          <a href="<?php echo base_url(); ?>gudanglogistik/inputsaldoawal" class="btn btn-danger mb-3">Tambah Data</a>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td width="180px">
                      <a href="#" data-kode_saldoawal_gl="<?php echo $d['kode_saldoawal_gl']; ?>" class="btn btn-sm btn-primary detail">Detail</a>
                      <a href="<?php echo base_url(); ?>gudanglogistik/inputdetailsaldoawal/<?php echo $kode_saldoawal_gl; ?>" class="btn btn-sm btn-success">Input</a>
                      <a href="#" data-href="<?php echo base_url(); ?>gudanglogistik/hapussaldoawal/<?php echo $kode_saldoawal_gl; ?>" class="btn btn-sm btn-danger hapus">Hapus</a>
                    </td>
                  </tr>
                <?php
                  $no++;
