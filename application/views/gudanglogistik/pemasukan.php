  ...
  <div class="row">
    <div class="col-md-10 col-xs-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>gudanglogistik/pemasukan" autocomplete="off">
            <div class="mb-3">
          ...
          <a href="<?php echo base_url(); ?>gudanglogistik/input_pemasukan" class="btn btn-danger mb-3">Tambah Data</a>
                ...
                ?>
                  <tr>
                    ...
                    <td width="10px">
                      ...
                      <a href="#" data-href="<?php echo base_url(); ?>gudanglogistik/hapuspemasukan/<?php echo $nobukti; ?>" class="btn btn-sm btn-danger hapus">Hapus</a>
                    </td>
                  </tr>
                <?php
                  $no++;
