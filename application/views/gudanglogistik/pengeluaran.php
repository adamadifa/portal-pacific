  ...
  <div class="row">
    <div class="col-md-10 col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
          <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>gudanglogistik/pengeluaran" autocomplete="off">
            <div class="mb-3">
          ...
          <a href="<?php echo base_url(); ?>gudanglogistik/input_pengeluaran" class="btn btn-danger mb-3">Tambah Data</a>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="#" data-href="<?php echo base_url(); ?>gudanglogistik/hapuspengeluaran/<?php echo $nobukti; ?>" class="btn btn-sm btn-danger hapus">Hapus</a>
                      <a href="<?php echo base_url(); ?>gudanglogistik/edit_pengeluaran/<?php echo $nobukti; ?>" class="btn btn-sm btn-warning">Edit</a>
                    </td>
                  </tr>
                <?php
                  $no++;
