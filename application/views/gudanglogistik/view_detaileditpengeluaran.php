...
?>
  <tr>
    ...
    <td align="right"><a href="#" data-kodebarang="<?php echo $d->kode_barang; ?>" class="btn btn-danger btn-sm hapus">Hapus</a>
      <a href="#" data-cabang="<?php echo $d->kode_cabang; ?>" data-kodebarang="<?php echo $d->kode_barang; ?>" data-nama="<?php echo $d->nama_barang; ?>" data-ket="<?php echo $d->keterangan; ?>" data-jenis="<?php echo $d->jenis_barang; ?>" data-qty="<?php echo $d->qty; ?>" class="btn btn-warning btn-sm edit">Edit</a></td>
    </td>
  </tr>
<?php $no++;
} ?>
<script type="text/javascript">
  $(function() {
    ...
    $(".edit").click(function(e) {
      ...
      var kode_cabang = $(this).attr("data-cabang");
      var ket = $(this).attr("data-ket");
