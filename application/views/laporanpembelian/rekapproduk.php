        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                <form class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>laporanpembelian/cetakrekapbarang" target="_blank">
                  ...
                  <div class="form-group mb-3">
                    <select class="form-select show-tick" id="brg" name="brg" data-error=".errorTxt1">
