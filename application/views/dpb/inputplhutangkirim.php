        ...
        <div class="col-md-7">
          ...
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">INPUT DATA REKAP PELUNASAN HUTANG KIRIM DPB </h4>
            </div>
            <div class="card-body">
              <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>dpb/input_plhutangkirim">
                <div class="form-group mb-3">
                  <div class="input-icon">
                    ...
                    <input type="text" readonly value="" id="no_mutasi" name="no_mutasi" class="form-control" placeholder="No Mutasi Ganti Barang" data-error=".errorTxt19" />
                  </div>
                </div>
                <div class="form-group mb-3">
                  <div class="input-icon">
                ...
                <table class="table table-bordered table-striped">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th colspan="6" style="text-align:center">Pelunasan Hutang Kirim</th>
                    </tr>
                    <tr>
