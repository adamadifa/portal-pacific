        ...
        <div class="col-md-7">
          ...
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">UPDATE DATA REKAP HUTANG KIRIM </h4>
            </div>
            <div class="card-body">
              <form name="autoSumForm" autocomplete="off" class="formValidate" id="formValidate" method="POST" action="<?php echo base_url(); ?>dpb/update_hutangkirim">
                <div class="form-group mb-3">
                  <div class="input-icon">
                    ...
                    <input type="text" readonly value="<?php echo $mutasi['no_mutasi_gudang_cabang'] ?>" id="no_mutasi" name="no_mutasi" class="form-control" placeholder="No Mutasi Hutang Kirim" data-error=".errorTxt19" />
                  </div>
                </div>
                <div class="form-group mb-3">
                  <div class="input-icon">
                ...
                <div class="form-group mb-3">
                  <div class="input-icon">
                    ...
                    <input type="text" readonly value="<?php echo $mutasi['tgl_mutasi_gudang_cabang']; ?>" id="tgl_gb" name="tanggal" class="form-control datepicker" placeholder="Tanggal Hutang Kirim" data-error=".errorTxt19" />
                  </div>
                </div>
                <table class="table table-bordered table-striped">
                  <thead class="thead-dark">
                    <tr>
                      ...
                      <th colspan="6" style="text-align:center">Hutang Kirim</th>
                    </tr>
                    <tr>
