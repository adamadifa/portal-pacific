      ...
      <div class="row">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"> DATA REKAP PELUNASAN TTR DPB </h4>
          </div>
          <div class="card-body">
            <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>dpb/plttr" autocomplete="off">
            ...
            <hr>
            <a href="<?php echo base_url(); ?>dpb/inputplttr" class="btn btn-danger mb-3">Tambah Data</a>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo base_url(); ?>dpb/updateplttr/<?php echo $d['no_mutasi_gudang_cabang']; ?>" class="btn btn-sm btn-blue">Update</a>
                        <a data-href="<?php echo base_url(); ?>dpb/hapusplttr/<?php echo $d['no_mutasi_gudang_cabang']; ?>/<?php echo $d['kode_cabang']; ?>" class="btn btn-sm btn-red text-white hapus">Hapus</a>
                      </td>
                    </tr>
                  <?php
                    $sno++;
