...
class Gudangbahan extends CI_Controller
{
  function __construct()
  {
    parent::__construct();
    check_login();
    $this->load->model(array('Model_gudangbahan', 'Model_produksi'));
  }
  ...
  function returproduksi($rowno = 0)
  {
    ...
    $allcount                     = $this->Model_gudangbahan->getrecordPengeluaranCountR($nobukti, $tgl_pengeluaran, $kode_dept);
    $users_record                 = $this->Model_gudangbahan->getDataPengeluaranR($rowno, $rowperpage, $nobukti, $tgl_pengeluaran, $kode_dept);
    $config['base_url']           = base_url() . 'gudangbahan/returproduksi';
    ...
    $this->template->load('template/template', 'gudangbahan/returproduksi', $data);
  }
  ...
  function insert_returproduksi()
  {
    ...
    $this->Model_gudangbahan->insert_returproduksi();
  }
